    ...
    render() {
        ...
        return (
            <SafeAreaView forceInset={{ top: 'always', bottom: 'never' }} style={{ flex: 1 }}>
                <StatusBar backgroundColor={theme.colors.blue} barStyle="dark-content" hidden={false} networkActivityIndicatorVisible={true} />
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{}}>
                            ...
                            <View style={styles.container}>
                                <View style={{ justifyContent: 'center', marginLeft: 2, flexDirection: 'row' }}>
                                ...
                                <View style={{ marginLeft: '19%' }}>
                                    <TouchableOpacity onPress={() => this.onSend()}
                                        ...
                                        <Icon style={{ color: theme.colors.blue }} name={'md-send'} />
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>
